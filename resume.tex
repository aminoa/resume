...
% • Wrote paper discussing implementation of SentiTweet, the D3 visualization, and previous work 

% \textbf{\href{https://github.com/aminoa/dot-matrix}{Dot Matrix - Game Boy Emulator}} \hfill March 2023 \\
% • Designed x86 C++ emulator for the Game Boy platform by implementing the 255 standard opcodes and their functionality (registers, memory, timers) \newline
% • Wrote separate disassembler to obtain assembly instructions from program binary data \newline
% • Employed SDL library to simulate the graphics renderer via SDL textures and handle user input 
...
% \end{rSection}
% \textbf {NYU Syllabi} \hfill April 2023 - May 2023 \\
% • Developed Next.js/React application to assist NYU students with finding syllabi across different schools \\
% • Hosted Express.js API endpoint integrated with frontend using Next.js Router Handlers \\
% • Set up PostgreSQL database on Amazon Web Service (AWS) RDS and connected to AWS S3 storage \\
% • Deployed Next.js application using AWS Amplify Hosting
