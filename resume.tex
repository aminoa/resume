...
• Rewrote a core Kubernetes build tool in Rust, slashing Helm chart build times by 78\% (from 14 minutes to 3 minutes); successfully drove team-wide adoption of the tool and mentored external contractor to execute over 40 high-velocity deployments. \\
