...
\textbf{Affirm}, New York City, NY, {\emph{Software Engineer, Traffic Engineering}} \hfill July 2025 - Present \\
• Built self-serve secrets decryption service on AWS Lambda, reimplementing three-layer envelope decryption (KEK/DEK) with separate IAM ReaderRoles; automated 40 requests/month, eliminating 60 hours/year of toil. \\
...
• Added MBC1 ROM/RAM bank switching, joypad input, audio output, and save states, enabling playback of commercial titles.
...
%         Languages & C++, Rust, Python, Javascript, C\#, Java, Bash \\
