...
\textbf{Qualcomm}, San Diego, CA, {\emph{Software Engineer Intern, AI Software/ML Group}} \hfill May 2024 - Present \\ 
• Developed Memray-based memory monitor script to check IR graph converter/AIMET quantizer memory usage \\
• Contributed IR Quantizer C++ API calls to reduce memory overhead by 50\% by referencing IR graph weights
