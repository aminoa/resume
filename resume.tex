...
• Re-architected and built Affirm's secrets infrastructure end to end, including three-layer envelope encryption (KEK/DEK) with isolated IAM reader roles; shipped an engineer-facing decryption service on AWS Lambda with an agentic workflow, automating 40 requests/month and eliminating 60 hours/year of toil. \\
